...
| 10 | test-distribution, maven-plugin ITs, checkstyle/spotless re-enabled for the final build | 🔄 | checkstyle: 0 violations on the whole reactor; test-distribution running |
