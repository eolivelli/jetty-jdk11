...
public class ForceRequestHeaderValueRuleTest extends AbstractRuleTest
{
    public void start(ForceRequestHeaderValueRule rule) throws Exception
    {
        ...
        start(new Handler.Abstract()
        {
            ...
            public boolean handle(Request request, Response response, Callback callback)
            {
                ...
                {
                    Content.Sink.write(response, false, String.format("Request Header[%s]: [%s]%n", httpField.getName(), httpField.getValue()), Callback.NOOP);
                }
    ...
    public void testNormalRequest() throws Exception
    {
        ...
        String request = "GET /echo/foo HTTP/1.1\n" +
            "Host: local\n" +
            "Connection: close\n" +
            "\n";
