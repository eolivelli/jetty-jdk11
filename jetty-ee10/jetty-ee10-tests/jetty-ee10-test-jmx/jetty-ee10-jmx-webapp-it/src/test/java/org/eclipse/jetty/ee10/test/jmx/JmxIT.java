...
public class JmxIT
{
    ...
    public void prepare() throws Exception
    {
        ...
        Path war = webapps.resolve("jetty-ee10-jmx-webapp.war");
    ...
    {
        ObjectName webappName = new ObjectName("org.eclipse.jetty.ee10.webapp:type=webappcontext,*");
    ...
    {
        ObjectName commonName = new ObjectName("org.eclipse.jetty.ee10.test.jmx:type=commoncomponent,*");
    ...
    {
        ObjectName pingerName = new ObjectName("org.eclipse.jetty.ee10.test.jmx:type=pinger,*");
        // Get initial count
    ...
    {
        ObjectName echoerName = new ObjectName("org.eclipse.jetty.ee10.test.jmx:type=echoer,*");
        // Get initial count
